...
public class IssSubmitCommand implements Command {
	...
	public String execute(String... args) throws Exception {
		...
		for(int i = 0; i < jsonArr.size(); i++) {
			...
			String url = "https://baas.trustsql.qq.com/cgi-bin/v1.0/dam_asset_issue_submit.cgi";
			System.out.println("submit information into TrustSQL:");
